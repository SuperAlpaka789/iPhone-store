export enum ActionTypes {
  ADD_PRODUCT_TO_CART = '[add product to cart] add product to cart',
  // ADD_PRODUCT_TO_CART_SUCCESS = '[add product to cart] add product to cart success',
  // ADD_PRODUCT_TO_CART_FAILURE = '[add product to cart] add product to cart failure',
